# Generated by Django 2.2.13 on 2020-07-23 18:57
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('killmail', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='position', serialize=False, to='killtracker.EveKillmail')),
        ...
        migrations.CreateModel(
            name='EveKillmailZkb',
            fields=[
                ('killmail', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='zkb', serialize=False, to='killtracker.EveKillmail')),
                ('location_id', models.PositiveIntegerField(blank=True, db_index=True, default=None, null=True)),
                ('hash', models.CharField(blank=True, default='', max_length=64)),
                ('fitted_value', models.FloatField(blank=True, default=None, null=True)),
                ('total_value', models.FloatField(blank=True, db_index=True, default=None, null=True)),
                ('points', models.PositiveIntegerField(blank=True, db_index=True, default=None, null=True)),
                ('is_npc', models.BooleanField(blank=True, db_index=True, default=None, null=True)),
                ('is_solo', models.BooleanField(blank=True, db_index=True, default=None, null=True)),
                ('is_awox', models.BooleanField(blank=True, db_index=True, default=None, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Tracker',
            fields=[
                ...
                ('require_min_value', models.PositiveIntegerField(blank=True, default=None, help_text="Require killmail's value to be greater or equal to the given value in M ISK", null=True)),
                ...
                ('is_enabled', models.BooleanField(db_index=True, default=True, help_text='toogle for activating or deactivating a tracker')),
                ...
                ('origin_solar_system', models.ForeignKey(blank=True, default=None, help_text='Solar system to calculate distance and jumps from. When provided distance and jumps will be shown on killmail messages', null=True, on_delete=django.db.models.deletion.SET_DEFAULT, related_name='tracker_origin_solar_systems_set', to='eveuniverse.EveSolarSystem')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_final_blow', models.BooleanField(blank=True, db_index=True, default=None, null=True)),
                ('security_status', models.FloatField(blank=True, default=None, null=True)),
                ('alliance', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='evekillmailattacker_alliances_set', to='eveuniverse.EveEntity')),
                ('character', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='evekillmailattacker_characters_set', to='eveuniverse.EveEntity')),
                ('corporation', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='evekillmailattacker_corporations_set', to='eveuniverse.EveEntity')),
                ('faction', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='evekillmailattacker_factions_set', to='eveuniverse.EveEntity')),
                ('killmail', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='attackers', to='killtracker.EveKillmail')),
                ('ship_type', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='evekillmailattacker_shiptypes_set', to='eveuniverse.EveEntity')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('killmail', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='victim', serialize=False, to='killtracker.EveKillmail')),
                ('damage_taken', models.BigIntegerField(blank=True, default=None, null=True)),
                ('alliance', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='evekillmailvictim_alliances_set', to='eveuniverse.EveEntity')),
                ('character', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='evekillmailvictim_characters_set', to='eveuniverse.EveEntity')),
                ('corporation', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='evekillmailvictim_corporations_set', to='eveuniverse.EveEntity')),
                ('faction', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='evekillmailvictim_factions_set', to='eveuniverse.EveEntity')),
                ('ship_type', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='evekillmailvictim_shiptypes_set', to='eveuniverse.EveEntity')),
            ],
            options={
                'abstract': False,
            },
