# Generated by Django 2.2.13 on 2020-07-16 21:53
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('require_attacker_alliances', models.ManyToManyField(blank=True, default=None, help_text='only include killmails with attackers from one of these alliances', related_name='required_attacker_alliances_set', to='eveonline.EveAllianceInfo')),
                ('require_attackers_ship_groups', models.ManyToManyField(blank=True, default=None, help_text='Only include killmails where at least one attacker is flying one of these ship groups', limit_choices_to={'eve_category_id': 6}, related_name='require_attackers_ship_groups_set', to='eveuniverse.EveGroup')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('attackers_ship_groups', models.ManyToManyField(default=None, to='eveuniverse.EveGroup')),
