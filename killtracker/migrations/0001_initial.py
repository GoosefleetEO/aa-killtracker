# Generated by Django 2.2.12 on 2020-05-18 19:19
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('evesde', '0002_auto_20200518_1237'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('max_age', models.PositiveIntegerField(blank=True, default=4, help_text="ignore killmails that are older than the given number in hours (sometimes killmails appear belated on ZKB - this feature ensures they don't create new alerts)")),
                ('is_activated', models.BooleanField(default=True, help_text='toogle for activating or deactivating a tracker')),
                ...
                ('origin_solar_system', models.ForeignKey(blank=True, default=None, help_text='Solar system to calculate ranges and jumps from. (usually the staging system).', null=True, on_delete=django.db.models.deletion.SET_DEFAULT, to='evesde.EveSolarSystem')),
                ('require_attackers_ship_groups', models.ManyToManyField(blank=True, default=None, help_text='exclude killmails where attackers are flying one of these ship groups', related_name='require_attackers_ship_groups_set', to='evesde.EveGroup')),
        ...
        migrations.CreateModel(
            name='TrackerKillmail',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('is_matching', models.BooleanField(default=None, null=True)),
                ('date_sent', models.DateTimeField(default=None, null=True)),
                ('attackers_count', models.PositiveIntegerField(default=None, help_text='Calculated number of attackers', null=True)),
                ('jumps', models.PositiveIntegerField(default=None, help_text='Calculated number of jumps from origin', null=True)),
                ('distance', models.FloatField(default=None, help_text='Calculated distance from origin in lightyears', null=True)),
        ...
        migrations.AddField(
            model_name='tracker',
            name='webhook',
            field=models.ForeignKey(blank=True, default=None, help_text='Webhook URL for a channel on Discord to sent all alerts to', null=True, on_delete=django.db.models.deletion.SET_DEFAULT, to='killtracker.Webhook'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('weapon_type', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, to='killtracker.EveEntity')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            ...
            name='alliance',
            field=models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='killmailvictim_alliance_set', to='killtracker.EveEntity'),
        ),
        migrations.AddField(
            model_name='killmailvictim',
            name='character',
            field=models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='killmailvictim_character_set', to='killtracker.EveEntity'),
        ),
        migrations.AddField(
            model_name='killmailvictim',
            name='corporation',
            field=models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='killmailvictim_corporation_set', to='killtracker.EveEntity'),
        ),
        migrations.AddField(
            model_name='killmailvictim',
            name='faction',
            field=models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='killmailvictim_faction_set', to='killtracker.EveEntity'),
        ),
        migrations.AddField(
            model_name='killmailvictim',
            name='ship_type',
            field=models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='killmailvictim_shiptype_set', to='killtracker.EveEntity'),
        ),
    ]
