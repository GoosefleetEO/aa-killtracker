...
from evesde.models import EveRegion, EveSolarSystem, EveGroup, EveType
...
def load_evesde():
    ...
    sde_models = [
        EveGroup, EveType, EveRegion, EveSolarSystem
    ]
    ...
    for SdeModel in sde_models:
        for item in data[SdeModel.__name__]:
            ...
            if SdeModel == EveType:
                ...
                EveEntity.objects.create(
                    id=obj.solar_system_id,
                    name=obj.solar_system_name,
